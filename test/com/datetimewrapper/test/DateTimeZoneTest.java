 ...
 */
public class DateTimeZoneTest extends TestCase {
...
//                return super.implies(domain, permission);
    ...
    public static TestSuite suite() {
        return new TestSuite(DateTimeZoneTest.class);
    }

    public DateTimeZoneTest(String name) {
        super(name);
    }
    ...
    public void testForID_String() {
        assertEquals(DateTimeZone.getDefault(), DateTimeZone.forID("Europe/London"));
    ...
    public void testForOffsetHours_int() {
        ...
        assertEquals(DateTimeZone.forID("GMT+03:00"), DateTimeZone.forOffsetHours(3));
        assertEquals(DateTimeZone.forID("GMT-02:00"), DateTimeZone.forOffsetHours(-2));
        try {
    ...
    public void testForOffsetHoursMinutes_int_int() {
        ...
        assertEquals(DateTimeZone.forID("GMT+23:59"), DateTimeZone.forOffsetHoursMinutes(23, 59));
        
        assertEquals(DateTimeZone.forID("GMT+02:15"), DateTimeZone.forOffsetHoursMinutes(2, 15));
        assertEquals(DateTimeZone.forID("GMT+02:00"), DateTimeZone.forOffsetHoursMinutes(2, 0));
        try {
            DateTimeZone.forOffsetHoursMinutes(2, -15);
            fail();
        } catch (IllegalArgumentException ex) {}
        
        assertEquals(DateTimeZone.forID("GMT+00:15"), DateTimeZone.forOffsetHoursMinutes(0, 15));
        assertEquals(DateTimeZone.forID("UTC"), DateTimeZone.forOffsetHoursMinutes(0, 0));
        assertEquals(DateTimeZone.forID("GMT-00:15"), DateTimeZone.forOffsetHoursMinutes(0, -15));
    ...
    public void testForTimeZone_TimeZone() {
        assertEquals(DateTimeZone.getDefault(), DateTimeZone.forTimeZone(TimeZone.getTimeZone("Europe/London")));
    ...
    public void testTimeZoneConversion() {
        ...
        assertEquals("GMT-10:00", jodaTimeZone.getID());
    ...
    public void testConstructor() {
        assertEquals(4, DateTimeZone.class.getDeclaredConstructors().length);
    }
    ...
    public void testGetOffset_RI() {
        DateTimeZone zone = DateTimeZone.forID("Europe/Paris");
        assertEquals(2L * DateTimeConstants.MILLIS_PER_HOUR, zone.getOffset(new Instant(TEST_TIME_SUMMER).getMillis()));
        assertEquals(1L * DateTimeConstants.MILLIS_PER_HOUR, zone.getOffset(new Instant(TEST_TIME_WINTER).getMillis()));
    }

    public void testGetOffsetFixed() {
        DateTimeZone zone = DateTimeZone.forID("GMT+01:00");
    ...
    public void testGetOffsetFixed_RI() {
        DateTimeZone zone = DateTimeZone.forID("GMT+01:00");
        assertEquals(1L * DateTimeConstants.MILLIS_PER_HOUR, zone.getOffset(new Instant(TEST_TIME_SUMMER).getMillis()));
        assertEquals(1L * DateTimeConstants.MILLIS_PER_HOUR, zone.getOffset(new Instant(TEST_TIME_WINTER).getMillis()));
    }
    ...
    public void testEqualsHashCode() {
        ...
        DateTimeZone zone4 = DateTimeZone.forID("GMT+01:00");
        ...
        DateTimeZone zone5 = DateTimeZone.forID("GMT+02:00");
    ...
    public void testSerialization1() throws Exception {
        ...
        oos.writeObject(zone.getTimeZone());
        byte[] bytes = baos.toByteArray();
        oos.close();
        
        ByteArrayInputStream bais = new ByteArrayInputStream(bytes);
        ObjectInputStream ois = new ObjectInputStream(bais);
        DateTimeZone result = (DateTimeZone) new DateTimeZone((TimeZone) ois.readObject());
        ois.close();
